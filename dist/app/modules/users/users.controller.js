...
const deleteSingleUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const result = yield users_service_1.User_Services.deleteSingleUserintoDB(userId);
        console.log(result);
        res.status(200).json({
            success: true,
...
const createOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield users_service_1.User_Services.createOrderIntoDB(userId, order);
        console.log(result);
        res.status(200).json({
            success: true,
...
const getTotalPriceOfOrders = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const result = yield users_service_1.User_Services.getTotalPriceOfOrderIntoDB(userId);
        res.status(200).json({
            success: true,
