...
router.delete(
  '/users/:userId',
  users_controller_1.User_Controller.deleteSingleUser,
);
router.put(
  '/users/:userId/orders',
  users_controller_1.User_Controller.createOrder,
);
router.get(
  '/users/:userId/orders',
  users_controller_1.User_Controller.getAllOrders,
);
router.get(
  '/users/:userId/orders/total-price',
  users_controller_1.User_Controller.getTotalPriceOfOrders,
);
